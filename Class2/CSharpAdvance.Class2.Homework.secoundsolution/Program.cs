using CSharpAdvance.Class2.Homework.Secoundsolution.Classes;
using CSharpAdvance.Class2.Homework.Secoundsolution.Interfaces;
using System;
using System.Collections.Generic;

namespace CSharpAdvance.Class2.Homework.Secoundsolution
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Student bob = new Student(4, "Bob", "bob", "bob123", bobGrades);
            Student jil = new Student(7, "Jil", "jil", "jil321", jilGrades);
