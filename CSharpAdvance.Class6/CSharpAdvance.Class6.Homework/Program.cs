...
namespace CSharpAdvance.Class6.Homework
{
    public class Person
    {
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Baranje 1:Find and print all persons firstnames  starting with 'R', ordered by Age -DESCENDING ORDER
            List<string> baranje1 = people
                           .OrderByDescending(x => x.Age)
                           .Select(x => x.FirstName)
                           .Where(x => x.StartsWith("R"))
                           .ToList();
            baranje1.ForEach(x => Console.WriteLine(x));

            Console.WriteLine("===================================================");

            //Baranje 2: Find and print all brown dogs names and ages older than 3 years, ordered by Age -ASCENDING ORDER
            List<Dog> baranje2 = dogs
                           .OrderBy(x => x.Age)
                           .Where(x => x.Color == "Brown" && x.Age > 3)
                           .ToList();
            baranje2.ForEach(x => Console.WriteLine($"Name: {x.Name}, Age: {x.Age}"));

            Console.WriteLine("===================================================");

            //Baranje 3:Find and print all persons with more than 2 dogs, ordered by Name -DESCENDING ORDER

            List<Person> baranje3 = people
                            .OrderByDescending(x => x.FirstName)
                            .Where(x => x.Dogs.Count > 2)
                            .ToList();
            baranje3.ForEach(x => Console.WriteLine(x.FirstName));

            Console.WriteLine("===================================================");

            //Baranje 4:Find and print all Freddy`s dogs names older than 1 year

            List<string> baranje4 = people
                                .SingleOrDefault(x => x.FirstName == "Freddy").Dogs
                                .Where(x => x.Age > 1)
                                .Select(x => x.Name)
                                .ToList();
            baranje4.ForEach(x => Console.WriteLine(x));

            Console.WriteLine("===================================================");

            //Baranje 5:Find and print Nathen`s first dog
            ...
            Console.WriteLine(baranje5.Name);

            Console.WriteLine("===================================================");

            //Baranje 6:Find and print all white dogs names from Cristofer, Freddy, Erin and Amelia, ordered by Name -ASCENDING ORDER

            List<string> baranje6 = people
